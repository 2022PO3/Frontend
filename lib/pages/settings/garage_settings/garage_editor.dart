        ...
        child: Column(
          ...
          children: [
            ...
            EditableField<String>(
              ...
              nameTextStyle: nameTextStyle(context),
              valueTextStyle: valueTextStyle(context),
              onEdit: (municipality) => setLocation(
                  currentValue.copyWith(municipality: municipality)),
            ),
            EditableField<int>(
        ...
        child: Column(
          ...
          children: [
            EditableField<int>(
              ...
              nameTextStyle: nameTextStyle(context),
              valueTextStyle: valueTextStyle(context),
              onEdit: (maxHandicappedLots) => setSettings(currentValue.copyWith(
                  maxHandicappedLots: maxHandicappedLots)),
            ),
            EditableField<int>(
              ...
              nameTextStyle: nameTextStyle(context),
              valueTextStyle: valueTextStyle(context),
              onEdit: (electricCars) => setSettings(
                  currentValue.copyWith(electricCars: electricCars)),
            ),
            const Divider(),
