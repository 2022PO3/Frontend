...
class _ProfileState extends State<Profile> {
  ...
  Widget build(BuildContext context) {
    ...
    Future openFirstnameDialog() => showDialog(
        ...
        builder: (context) => AlertDialog(
              title: Row(children: [
                ...
                Text(UserinfoPr.getUser.firstName ?? 'User',
    ...
    Future openPasswordDialog() => showDialog(
        ...
        builder: (context) => AlertDialog(
              ...
              content: Column(mainAxisSize: MainAxisSize.min, children: [
                const Text('Your are about to change your password',
                    style: TextStyle(
                        ...
                        if (_passwordMatch &&
                          ...
                          try {
                            await setUserPassword(
                                newPassword, oldPassword, passwordConfirmation);
                            if (mounted) {
              ...
              Column(
                children: [
                  ...
                  Row(children: [
                    ...
                    Text(UserinfoPr.getUser.id.toString(),
                  ...
                  Row(
                      ...
                      children: [
                        Row(children: [
                          const Text('E-mail adress: ',
                              style: TextStyle(fontSize: 20)),
                          Text(UserinfoPr.getUser.email,
                              style: const TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                              ))
                  ...
                  const SizedBox(height: 10),
                  Row(children: [
                    const Text('Id favorite garage: ',
                        style: TextStyle(
                          fontSize: 20,
                        )),
                    Text(UserinfoPr.getUser.favGarageId.toString(),
                        style: const TextStyle(
                            fontSize: 20, fontWeight: FontWeight.bold))
                  ]),
                  const SizedBox(height: 10),
                  ...
                  TextButton(
                      ...
                      child: const Text('Change you password',
                          style: TextStyle(fontSize: 20))),
                ],
              ),
              Column(children: [
  ...
  Future<bool> setFirstName(String newFirstName) async {
    ...
    if (userProvider.getUser.location == null) {
      ...
      setState(() {
        location = abbreviateProvince(
            Province.getProvinceName(userProvider.getUser.location));
      });
    }
  ...
  Future<bool> setUserPassword(String oldPassword, String newPassword,
